...
# Usage: ./vc_mn.sh <normal sample name> <tumor sample name>
...
gatk Mutect2 \
    ...
    --f1r2-tar-gz 3_var/filter_files/${TUMOR}.f1r2.tar.gz \
...
gatk CalculateContamination \
    ...
    --output 3_var/filter_files/${TUMOR}_mn_${NORMAL}.contamination

gatk LearnReadOrientationModel \
    --input 3_var/filter_files/${TUMOR}.f1r2.tar.gz \
    --output 3_var/filter_files/${TUMOR}.read-orientation-model.tar.gz

gatk FilterMutectCalls \
    --reference ${FASTA} \
    --variant 3_var/${TUMOR}.raw.vcf.gz \
    --contamination-table 3_var/filter_files/${TUMOR}_mn_${NORMAL}.contamination \
    --orientation-bias-artifact-priors 3_var/filter_files/${TUMOR}.read-orientation-model.tar.gz \
